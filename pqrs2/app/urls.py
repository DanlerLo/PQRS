...
from .views import home, about, blog, portfolio, registros, agregar_producto, listar_producto, modificar_producto, eliminar_producto, peticiones, quejas, reclamos, sugerencias, post
urlpatterns = [
    path('', home, name='home'),
